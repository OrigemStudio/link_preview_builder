...
class WebAnalyzer {
  ...
  static Future<Response?> _requestUrl(String url,
    ...
    final request = Request('GET', uri)
      ...
      ..headers["Cookie"] =
          '{"weibo.com":"YF-Page-G0=02467fca7cf40a590c28b8459d93fb95|1596707497|1596707497; SUB=_2AkMod12Af8NxqwJRmf8WxGjna49_ygnEieKeK6xbJRMxHRl-yT9kqlcftRB6A_dzb7xq29tqJiOUtDsy806R_ZoEGgwS; SUBP=0033WrSXqPxfM72-Ws9jqgMF55529P9D9W59fYdi4BXCzHNAH7GabuIJ"}'
      ..headers["accept"] = "*/*";
    final stream = request.send();
    await stream.then((value) async {
      if (value.statusCode == HttpStatus.movedTemporarily ||
          value.statusCode == HttpStatus.movedPermanently) {
        if (value.isRedirect && count < 6) {
          final String? location = value.headers['location'];
          if (location != null) {
            url = location;
        ...
        response = await Response.fromStream(value);
        if (uri.host == "m.tb.cn") {
          final match = RegExp(r"var url = \'(.*)\'").firstMatch(response.body);
          if (match != null) {
